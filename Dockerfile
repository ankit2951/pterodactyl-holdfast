...
## Steamclient.so Link
RUN ln -s "/home/container/steamcmd/linux32/steamclient.so" "/usr/lib/i386-linux-gnu/steamclient.so" \
    && ln -s "/home/container/steamcmd/linux64/steamclient.so" "/usr/lib/x86_64-linux-gnu/steamclient.so" 
